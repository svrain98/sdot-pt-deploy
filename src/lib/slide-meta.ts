...
export const SLIDE_META: SlideMeta[] = [
  ...
  { id: "S05", number: 5, title: "전술 AI가 나아가는 방향", subtitle: "Parameters + IEEE MILCOM", presenter: "instructor", duration: "55s", steps: 2, notes: "2열 논문 인용 카드 + 결론." },
  ...
  { id: "S07", number: 7, title: "S-DOT 시스템 개념도", subtitle: "Edge · Network · C2", presenter: "instructor", duration: "1'00\"", steps: 3, notes: "3레이어 카드 + 파이프라인." },
  { id: "S08", number: 8, title: "데모 구현 조건", subtitle: "구현 범위 및 제한사항", presenter: "instructor", duration: "1'00\"", steps: 1, notes: "4조건 리스트 + 하단 메시지." },

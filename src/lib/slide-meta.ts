...
// 21장 슬라이드 메타데이터 — 본편 21장 + 부록 1장(미배포)
// 전반부 S01~S08: 교관님 담당 (도입·문제·솔루션 개요)
// 후반부 S10~S21 및 S09(시나리오 소개): 개발자 담당 — 파이프라인·KPI 뒤에 시나리오 소개 배치
...
export const SLIDE_META: SlideMeta[] = [
  ...
  // ───── 후반부 (개발자) — 파이프라인 줌 시퀀스 ─────
  { id: "S10", number: 9, title: "S-DOT 전체 파이프라인", subtitle: "ISR · Foundry · AIP · Decision", presenter: "ceo", duration: "30s", steps: 1, notes: "4박스 overview." },
  { id: "S11", number: 10, title: "Edge 확대: 드론 영상 → 온톨로지", subtitle: "VLM 기반 온톨로지 변환", presenter: "ceo", duration: "50s", steps: 1, notes: "Box 1 줌인 + drone_semantic.mp4. 61MB→88B." },
  { id: "S12", number: 11, title: "전체 파이프라인으로 복귀", subtitle: "다음: Foundry 온톨로지", presenter: "ceo", duration: "10s", steps: 1, notes: "줌아웃. Box 1 ✓ 표시." },
  { id: "S13", number: 12, title: "Foundry 확대: 온톨로지 빅데이터", subtitle: "16 Object Types · Traceability", presenter: "ceo", duration: "50s", steps: 1, notes: "Box 2 줌인 + foundry 그래프." },
  { id: "S14", number: 13, title: "전체 파이프라인으로 복귀", subtitle: "다음: AIP Logic", presenter: "ceo", duration: "10s", steps: 1, notes: "줌아웃. Box 1·2 ✓ 표시." },
  { id: "S15", number: 14, title: "AIP + 결심 확대", subtitle: "5단계 분석 → 지휘관 결심", presenter: "ceo", duration: "50s", steps: 1, notes: "Box 3·4 동시 줌인 + AIP 5단계." },
  { id: "S16", number: 15, title: "KPI", subtitle: "Before → After · Mode A / B / COSE", presenter: "ceo", duration: "30s", steps: 2, notes: "4 KPICard + BarChart." },
  // ───── 시나리오 소개 (KPI 뒤, 1파 시뮬레이션 앞) ─────
  { id: "S09", number: 16, title: "데모 시나리오: 아우디우카 전투", subtitle: "S-DOT 데모가 2차파 재진입을 포착했다", presenter: "ceo", duration: "1'10\"", steps: 2, notes: "타임라인 + 좌우 분할 + 핵심 메시지 박스." },

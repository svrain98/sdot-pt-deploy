...
export default function S10_PipelineOverview({ meta }: SlideProps) {
  return (
    <SlideFrame meta={meta} transparent>
      ...
      >
        <div className="inline-block rounded-card border border-accent/60 bg-black/70 px-4 py-1.5 text-[22px] font-medium uppercase tracking-label text-accent backdrop-blur-sm">
          S-DOT Pipeline · Overview
        </div>
        <h2 className="mt-3 max-w-[900px] rounded-card border border-border bg-black/70 px-6 py-4 text-[56px] font-black leading-[1.1] tracking-heading text-fg backdrop-blur-sm">
      ...
      >
        <div className="rounded-card border border-border bg-black/75 p-6 text-right backdrop-blur-sm">
          ...
          <p className="text-[26px] leading-[1.45] text-fg-muted">
          ...
          <p className="mt-2 text-[22px] text-fg-dim">
            각 단계를 하나씩 들어가 봅니다.
          </p>
        </div>
      </motion.div>

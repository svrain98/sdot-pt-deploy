    ...
    <SlideFrame meta={meta}>
      <div className="flex h-full w-full flex-col px-[140px] pt-[140px] pb-[120px]">
        ...
        <div className="mt-10 grid flex-1 grid-cols-2 gap-8">
          ...
          >
            <span className="inline-block border border-accent/50 rounded-card px-3 py-1 text-[14px] text-accent">
              Parameters · 2025
            </span>
            <p className="mt-3 text-[16px] text-fg-dim">미 육군 전쟁대학 학술지</p>
            <div className="mt-6 border-l-2 border-accent pl-6">
              <p className="text-[18px] text-fg leading-[1.6]">
                &ldquo;AI가 현장 데이터를 압축해 결심에 필요한 것만 전달하는 것이 현대 지휘의 핵심&rdquo;
              </p>
            </div>
            <p className="mt-4 text-[16px] font-semibold text-accent">
          ...
          >
            ...
            <p className="mt-3 text-[16px] text-fg-dim">
            ...
            <p className="mt-4 text-[17px] text-fg-muted leading-[1.6]">
        ...
        >
          ...
          <p className="mt-2 text-[18px] font-semibold text-accent">
            → S-DOT는 그 방향의 구현
          </p>
        </motion.div>
      </div>

  ...
  return (
    ...
    >
      <div className="flex h-full w-full flex-col items-center justify-center px-[160px] pt-[150px] pb-[130px] text-center">
        ...
        >
          <div className="text-[40px] font-medium leading-[1.3] tracking-heading text-fg-muted drop-shadow-lg">
            영상을 보내는 시대에서,
          </div>
          <div className="mt-3 text-[72px] font-black leading-[1.1] tracking-heading text-fg drop-shadow-lg">
        ...
        <motion.div
          ...
          className="mt-10 max-w-[1100px] rounded-card bg-black/55 px-8 py-5 text-[26px] leading-[1.55] text-fg-muted backdrop-blur-sm"
        >
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <div className="text-[42px] font-black tracking-heading text-fg drop-shadow-lg">
            감사합니다.
          </div>
          <div className="mt-2 font-mono text-[18px] uppercase tracking-[0.3em] text-accent">
